...
if mode == "Upload Image":
    ...
    if uploaded_img and st.session_state["name"] and st.session_state["country"] and st.session_state["consent"]:
        ...
        with col1:
            ...
            st.image(img, caption="🌊 Original Image", use_column_width=True,use_container_width=True)
        ...
        with col2:
            ...
            for r in results:
                ...
                st.markdown('<div class="image-box">', unsafe_allow_html=True)
                st.image(output, caption="🤖 AI Detection Result", use_column_width=True,use_container_width=True)
                st.markdown("</div>", unsafe_allow_html=True)
